...
<div class="pagination-bar" onclick={handleClickOutside}>
	...
	{#if totalPages > 1}
		<div class="pagination-center">
			<button class="page-btn" disabled={currentPage <= 1} onclick={() => goToPage(1)} title="Primera página">
				<span class="material-icons" style="font-size:14px">first_page</span>
			</button>
			<button class="page-btn" disabled={currentPage <= 1} onclick={() => goToPage(currentPage - 1)} title="Página anterior">
			...
			<button class="page-btn" disabled={currentPage >= totalPages} onclick={() => goToPage(currentPage + 1)} title="Página siguiente">
				<span class="material-icons" style="font-size:14px">chevron_right</span>
			</button>
			<button class="page-btn" disabled={currentPage >= totalPages} onclick={() => goToPage(totalPages)} title="Última página">
