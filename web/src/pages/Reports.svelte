		...
		<div class="topbar">
			<div class="topbar-left">
				<div class="search-box">
					...
					<input type="text" bind:value={searchQuery} placeholder="Buscar por título, autor, ID, tipo o etiqueta..." />
				</div>
			</div>
			<div class="topbar-right">
				...
				/>
				<button class="topbar-btn" onclick={refreshReports} disabled={isLoading}>Aplicar</button>
				<button
					class="topbar-btn"
					onclick={() => {
						filterStartDate = "";
			...
			>Limpiar</button>
		<button class="topbar-btn btn-primary" onclick={createNewReport}>Nuevo Reporte</button>
			</div>
		</div>
				...
				{:else if filteredReports.length === 0}
					<div class="empty-state">
						<div class="empty-content">
							...
							<span class="empty-title">No se encontraron reportes</span>
